#!/bin/bash
#SBATCH --job-name=puma_remdm_nfe_sweep_progressive
#SBATCH --partition=general
#SBATCH --output=logs/eval_remdm_nfe_sweep_progressive_%j.log
#SBATCH --error=logs/eval_remdm_nfe_sweep_progressive_%j.err
...
# ============================================================================
# ReMDM NFE sweep — progressive_edit checkpoint
#
...
PRETRAINED_CKPT="/data/user_data/frankwu2/PUMA/checkpoints/sudoku_hard-pretraining-corrected/progressive_edit-s123_date2026-03-30-12-48/step460000.pt"
...
echo "=========================================="
echo "Starting ReMDM NFE Sweep (hard, progressive)"
echo "=========================================="
