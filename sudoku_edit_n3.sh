#!/bin/bash
#SBATCH --job-name=puma_sudoku_edit
#SBATCH --partition=general
#SBATCH --output=logs/train_sudoku_edit_n3_%j.log
#SBATCH --error=logs/train_sudoku_edit_n3_%j.err
...
# ============================================================================
CONFIG_FILE="yaml_files/sudoku_puma_edit_n3.yaml"
...
# ============================================================================
echo "=========================================="
echo "Starting PUMA Training - Sudoku Edit (n3)"
echo "=========================================="
echo "Config File: ${CONFIG_FILE}"
echo "Training starts at: $(date)"
echo ""

python train_edit.py --cfg ${CONFIG_FILE}
